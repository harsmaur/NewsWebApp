      ...
      <>
        ...
        <div>
             ...
             <Routes>
               ...
               <Route  exact path="/general" element={<News setProgress={setProgress} apiKey={apiKey} key='general' pageSize ={9} country={ 'in'} category={'general'}/>} ></Route>
               ...
               <Route  exact path="/science" element={<News setProgress={setProgress} apiKey={apiKey} key='science' pageSizhealthe ={9} country={ 'in'} category={'science'}/>} ></Route>
